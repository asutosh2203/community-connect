...
import { Map, Users, HeartHandshake, Zap, BarChart3, ChevronRight, Menu } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 font-sans text-gray-800 antialiased">
      ...
      <header className="sticky top-0 z-50 w-full bg-white/90 backdrop-blur-sm shadow-sm">
        <div className="container mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          <Link href="/" className="flex items-center space-x-2 text-2xl font-extrabold text-indigo-600 transition-transform hover:scale-105">
          ...
          <nav className="hidden items-center space-x-4 md:flex">
            <Link href="#how-it-works" className="rounded-lg px-3 py-2 text-gray-600 hover:bg-gray-100 hover:text-indigo-600 transition duration-150 font-medium">
              How it works
            </Link>
            <Link href="#features" className="rounded-lg px-3 py-2 text-gray-600 hover:bg-gray-100 hover:text-indigo-600 transition duration-150 font-medium">
              Features
            </Link>
            
            <div className="w-px h-6 bg-gray-200"></div>

            <Link href="/auth/login" className="rounded-lg px-4 py-2 text-indigo-600 font-semibold hover:bg-indigo-50 transition duration-200">
              Log In
            </Link>
            <Link 
              href="/auth/register" 
          ...
          {/* Mobile Menu Button */}
          <button className="md:hidden rounded-lg p-2 text-gray-700 hover:bg-gray-100 transition duration-150 focus:outline-none focus:ring-2 focus:ring-gray-300">
        ...
        <section className="relative bg-white pt-16 pb-24 sm:pt-24 sm:pb-32 lg:pt-32">
          ...
          <div className="container mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
            ...
            <p className="mx-auto mt-6 max-w-3xl text-xl text-gray-600">
              From needing a hand moving furniture to finding a local tutor, CommunityConnect links you directly with neighbours offering skills and resources right around the corner.
            </p>
              ...
              <div className="rounded-3xl bg-white p-4 sm:p-6 shadow-2xl shadow-indigo-200/50 ring-1 ring-gray-900/10">
                ...
                <div className="flex items-center justify-between mb-3 px-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="font-semibold text-gray-700">LIVE: Your Area</span>
                  </div>
                  <span className="text-sm font-medium text-indigo-600">Filters</span>
                </div>
                {/* "Map" area */}
        ...
        <section id="how-it-works" className="bg-gray-50 py-24 sm:py-32">
          <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <p className="mx-auto mt-4 max-w-3xl text-xl text-gray-600 text-center">
              Our map-driven platform streamlines finding and providing local services in three easy steps.
            </p>

            <div className="mt-16 grid grid-cols-1 gap-10 md:grid-cols-3">
              {/* Step 1 */}
              <div className="rounded-xl bg-white p-8 text-center shadow-lg border-t-4 border-indigo-500">
                <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-indigo-100 text-indigo-600 mb-5 text-2xl font-bold">1</div>
                <h3 className="text-2xl font-semibold text-gray-900">Pin Your Need</h3>
                <p className="mt-2 text-gray-600">
                  Post a Request (e.g., *Need a tutor*) or an Offer (*I offer tool rental*) right on your local map.
                </p>
              </div>
              {/* Step 2 */}
              <div className="rounded-xl bg-white p-8 text-center shadow-lg border-t-4 border-indigo-500">
                <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-indigo-100 text-indigo-600 mb-5 text-2xl font-bold">2</div>
                <h3 className="text-2xl font-semibold text-gray-900">Get Matched</h3>
                <p className="mt-2 text-gray-600">
                  Nearby members see your pin instantly. Accept the best offer or chat to coordinate the details live.
                </p>
              </div>
              {/* Step 3 */}
              <div className="rounded-xl bg-white p-8 text-center shadow-lg border-t-4 border-indigo-500">
                <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-indigo-100 text-indigo-600 mb-5 text-2xl font-bold">3</div>
                <h3 className="text-2xl font-semibold text-gray-900">Connect & Complete</h3>
                <p className="mt-2 text-gray-600">
                  Close the loop, provide honest ratings, and help build a trustworthy community economy.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16">
                    ...
                    <div className="flex items-start space-x-6 p-6">
                        ...
                        <div>
                            <h3 className="text-xl font-bold text-gray-900">Real-Time Event Coordination</h3>
                            <p className="mt-2 text-gray-600">
                                Instant updates via WebSockets for new requests and live chat. Zero polling, minimal latency, and dedicated channels for specific service coordinates.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-6 p-6">
                        ...
                        <div>
                            <h3 className="text-xl font-bold text-gray-900">Optimized Geospatial Search</h3>
                            <p className="mt-2 text-gray-600">
                                Utilizing PostGIS with PostgreSQL for lightning-fast radius filtering, clustering, and distance calculation—find what you need in under 100ms.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-6 p-6">
                        ...
                        <div>
                            <h3 className="text-xl font-bold text-gray-900">Service Heatmap Analytics</h3>
                            <p className="mt-2 text-gray-600">
                                Admins and power-users get a dashboard showing visual heatmaps of active request density and trending service categories across their zone.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-6 p-6">
                        ...
                        <div>
                            <h3 className="text-xl font-bold text-gray-900">AI-Powered Suggestion Engine</h3>
                            <p className="mt-2 text-gray-600">
                                Intelligent matching recommends the top 3 best-fit providers based on proximity, historical success rate, and skill tags immediately upon request.
                            </p>
                        </div>
                    </div>
        ...
        <section className="bg-indigo-700">
          <div className="container mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-xl text-indigo-200 text-center">
              Stop scrolling and start doing. Join the platform built for real, local value and connect with your neighbours today.
            </p>
